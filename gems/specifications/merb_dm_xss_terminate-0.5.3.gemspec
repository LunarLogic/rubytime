...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/merb_dm_xss_terminate", "lib/merb_dm_xss_terminate/html", "lib/merb_dm_xss_terminate/html/selector.rb", "lib/merb_dm_xss_terminate/html/node.rb", "lib/merb_dm_xss_terminate/html/tokenizer.rb", "lib/merb_dm_xss_terminate/html/document.rb", "lib/merb_dm_xss_terminate/html/version.rb", "lib/merb_dm_xss_terminate/html/sanitizer.rb", "lib/merb_dm_xss_terminate/html5lib_sanitize.rb", "lib/merb_dm_xss_terminate/merbtasks.rb", "lib/merb_dm_xss_terminate/rails_sanitize.rb", "lib/merb_dm_xss_terminate/xss_terminate.rb", "lib/merb_dm_xss_terminate.rb", "spec/merb_dm_xss_terminate_spec.rb", "spec/spec_helper.rb", "spec/schema.rb", "spec/config", "spec/config/database.yml", "spec/models", "spec/models/review.rb", "spec/models/message.rb", "spec/models/person.rb", "spec/models/entry.rb", "spec/models/page.rb", "spec/models/comment.rb"]
  s.has_rdoc = true
