...
You need to have Ruby version 1.8.6 or 1.8.7 and RubyGems 1.3.6+ installed on your server. You also need the Bundler gem (0.9+).

h3. Get the source

Next get the source code from RubyTime git repository:
