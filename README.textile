...
You need to have Ruby version 1.8.7 and RubyGems 1.3.6+ installed on your server. You also need the Bundler gem (1.0+).
...
* run @bundle exec rake db:seed@ to populate database tables with initial data (admin account, example clients and projects)
...
bc. MERB_ENV=production bundle exec rake db:seed
